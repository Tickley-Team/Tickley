  ...
  return (
    <Box sx={{ display: 'flex' }}>
      {categoryNames.map((categoryName, idx) => (
        <Button
        style={{width: "52px", padding:"0, 12px"; padding-right: 12px; background: #040404; border-radius: 4px; overflow: hidden; justify-content: center; align-items: center; gap: 4px; display: flex"}}
