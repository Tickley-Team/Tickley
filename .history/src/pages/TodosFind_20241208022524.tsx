...
const TodosFind = () => {
  ...
  const { spareTime,categoryName, setCategoryName } = useRecommendTodoFilterStore()
  const filteredTodos = todosMockData.filter((todo)=> todo.categoryName === categoryName && todo.estimateTime === )
